...
/**
  * @brief  MPU Data State Enumerated Type
  *
  * This enumerated type defines the possible states of the MPU data.
  */
typedef enum
{
  MPU_DATA_STATE_NOT_REQUESTED,		/*!< The MPU data isn't requested yet */
  MPU_DATA_STATE_REQUESTED,    		/*!< The MPU data is in the requested state */
  MPU_DATA_STATE_RECEIVED,			/*!< The MPU data is received for modify */
  MPU_DATA_STATE_READY    			/*!< The MPU data is ready for use */
} MPU_DATA_STATE;
...
typedef struct
{
    ...
    MPU_DATA_STATE dataState;			   /*!< Current state of the MPU data */
