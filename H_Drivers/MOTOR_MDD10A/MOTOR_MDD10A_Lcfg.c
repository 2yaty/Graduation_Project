 ...
 * 			Specifies the GPIO port that connected to the Motor pin direction.
 *          This parameter can be any value of @ref GPIO_port_define.
 * 		(*) uint16_t Motor_Dir_Pin :
 * 			Specifies the GPIO pins that connected to the motor pin direction.
 *          This parameter can be any value of GPIO_PIN_0 to GPIO_PIN_15.
 * 		(*) uint16_t Motor_Channel :
 * 			Specifies the TIM channel that connected to the Motor driver.
 ...
 * 			to initialize these pins in GPlow level initialization. Also the channel pins .
 *
 *
 */
