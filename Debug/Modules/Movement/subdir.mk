...
C_SRCS += \
../Modules/Movement/MOv.c 

OBJS += \
./Modules/Movement/MOv.o 

C_DEPS += \
./Modules/Movement/MOv.d 


# Each subdirectory must supply rules for building sources it contributes
Modules/Movement/%.o Modules/Movement/%.su Modules/Movement/%.cyclo: ../Modules/Movement/%.c Modules/Movement/subdir.mk
...
clean: clean-Modules-2f-Movement

clean-Modules-2f-Movement:
	-$(RM) ./Modules/Movement/MOv.cyclo ./Modules/Movement/MOv.d ./Modules/Movement/MOv.o ./Modules/Movement/MOv.su

.PHONY: clean-Modules-2f-Movement
